...
let BookFormComponent = class BookFormComponent {
    constructor(fb, bookExistsValidator) {
        this.fb = fb;
    ...
    submitForm() {
        ...
        const newBook = Object.assign({}, formValue, { isbn,
            authors,
            thumbnails });
...
let CreateBookComponent = class CreateBookComponent {
    ...
    createBook(book) {
        this.store.dispatch(new _actions_admin_actions__WEBPACK_IMPORTED_MODULE_3__["CreateBook"]({ book }));
    }
};
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.book$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(src_app_books_selectors_book_selectors__WEBPACK_IMPORTED_MODULE_5__["getBookByIsbn"], { isbn }));
        this.store.dispatch(new src_app_books_actions_book_actions__WEBPACK_IMPORTED_MODULE_4__["LoadBook"]({ isbn }));
    }
    updateBook(book) {
        this.store.dispatch(new _actions_admin_actions__WEBPACK_IMPORTED_MODULE_6__["UpdateBook"]({ book }));
    }
};
...
let FormMessagesComponent = class FormMessagesComponent {
    constructor() {
        this.allMessages = {
            title: {
...
let BookExistsValidatorService = class BookExistsValidatorService {
    constructor(bs) {
        this.bs = bs;
    }
    validate(control) {
        return this.bs.check(control.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(exists => (exists === false) ? null : {
...
class BookValidators {
    ...
    static atLeastOneAuthor(controlArray) {
